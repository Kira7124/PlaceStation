...
//    Request Header 설정
		...
		requestBody.put("imp_secret",
				fortOne.getImpSecret()); // Rest API Secret
																										// 키
...
//	     2. 포트원에 결제 정보 조회 == 결제 정보 사후 검증하기
	...
	// 환불 정책
	public boolean refund(String token, String merchant_uid , String impUid , String reason) {
...
//      토큰이 필요한듯?
		...
		params3.add("merchant_uid", merchant_uid); // 상품 넘버 (필수) -- 객체에서 가져오기
