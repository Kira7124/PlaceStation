...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>     
	...
	<form action="/admin/admin-noticeupdate" method="post" enctype="multipart/form-data">
		<div class="card mb-3" style="max-width: 700px;">
		      ...
		      <div class="card-body">
		        ...
		        <div class="row" style ="margin-top: 30px;">
		 		  ...
		 		  <div class="row" style ="margin-top: 30px;">
				    ...
				    <div class="col-md-5">
				        <div class="input-box">
				            <input type="text" class="form-control" name = "nwriter" id="bizid" placeholder="아이디입력">
				        </div>
				    </div>
				  </div>
				  <div class="row" style ="margin-top: 10px;">
				    ...
				    <div class="col-md-5">
				        <div class="input-box">
				            <input type="text" class="form-control" name = "ntitle" id="bizbrandname" placeholder="이름">
				        </div>
				    </div>
				</div>
			  <div class="row" style ="margin-top: 10px;">
		  ...
		  <div class="row">
            <div class="col-md-12">
                <button type="submit" class="btn btn-success" id="noticeupdateButton" style="margin-left:450px; margin-bottom: 10px; margin-top:10px;">수정하기</button>
            </div>
          </div>
