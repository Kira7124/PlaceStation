                ...
                <form class="form" action="" method="">
                  ...
                  <div class="form-group">
                    ...
                    border: none !important;">
                      <img src="assets/images/social_login/btnG_icon_square.png" class="social_btn">
                    </button>
                    <button type="button" class="social_btn"
                    style="height: 38px !important;
                    width: 47px !important;
                    background-color: white !important; 
                    border: none !important;">
                      <img src="assets/images/social_login/Asset 1.png" class="social_btn">
                    </button>
                    <button type="button" class="social_btn"
                    style="height: 38px !important;
                    width: 47px !important;
                    background-color: white !important; 
                    border: none !important;">
                      <img src="assets/images/social_login/web_light_sq_na@2x.png" class="social_btn">
                    </button>
                  </div>
                  </div>
                  <div class="form-group" style="position: absolute; width: 93%;">
                    <a href="" style="font-weight: 600;">Forgot Password?</a> 
                    <a href="/Titan-master/terms_user.html" style="float: right; font-weight: 600; position: relative; padding-left: 5%;">User Register</a>
                    <a href="/Titan-master/terms_seller.html" style="float: right; font-weight: 600; position: relative;">Seller Regist</a>
                    </div>
