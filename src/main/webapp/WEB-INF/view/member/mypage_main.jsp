...
<%@ include file ="/WEB-INF/view/layout/header.jsp" %>
    ...
    ">
        ...
        position: relative;
    "><img class="rounded-circle mt-5" id="profileImage" style=" width=150px;  border-radius: 50%; /* 이 값은 원의 반지름을 결정합니다. 50%는 이미지를 완전한 원 모양으로 만듭니다. */
        overflow: hidden; /* border-radius를 사용할 때 이미지의 경계를 제대로 처리하기 위해 필요합니다. */
        width: 200px; /* 이미지의 너비 */
        height: 200px; /"
