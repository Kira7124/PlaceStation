				...
				<div class="col-sm-6 col-sm-offset-3">
					<div class="post">
						<div class="post-header font-alt">
							<h2 class="post-title">공지사항 작성</h2>
						</div>
						<div class="post-entry">
							<form id="partyCreateForm" action="/party/announcement/create" method="post">
							<input type="hidden" name="partyNo" value="${party.partyNo}"/>
								<div class="form-group">
									<label for="partyName">공지사항 제목</label> <input type="text"
										class="form-control" id="partyAnnouncementTitle" name="partyAnnouncementTitle"
										placeholder="모임 이름을 입력하세요"> 
									<!-- 모임 설명 입력 폼 -->
									<label for="partyDescription">공지사항 설명</label>
									<textarea class="form-control" id="partyAnnouncementDescription"
										name="partyAnnouncementDescription" placeholder="공지사항 설명을 입력하세요" rows="30"></textarea>
								</div>
								<button type="submit" class="btn btn-d btn-circle">작성</button>
							</form>
						</div>
					</div>
				</div>
