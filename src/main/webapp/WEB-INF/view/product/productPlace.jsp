  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        <a href="index_mp_classic_video_background.html"
                          >Classic</a
                        >
                      </li>
                    </ul>
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        <a href="index_mp_classic_gradient_overlay.html"
                          >Classic</a
                        >
                      </li>
                    </ul>
                ...
                <div class="post">
                  <div class="post">
                    <div class="post-header font-alt">
                      <h2 class="post-title"><a href="#">제목 사이드</a></h2>
                      <div class="post-meta">
                        By&nbsp;<a href="#">Mark Stone</a>| 23 November | 3
                        Comments | <a href="#">Marketing, </a
                        ><a href="#">Web Design</a>
                      </div>
                    </div>
                    ...
                    <ul class="nav nav-tabs font-alt" role="tablist">
                      <li class="active">
                        <a href="#description" data-toggle="tab"
                          ><span class="icon-tools-2"></span>장소 소개</a
                        >
                      </li>
                      <li>
                        <a href="#data-sheet" data-toggle="tab"
                          ><span class="icon-tools-2"></span>이용 규칙</a
                        >
                      </li>
                      <li>
                        <a href="#reviews" data-toggle="tab"
                          ><span class="icon-tools-2"></span>리뷰</a
                        >
                      </li>
                      <li>
                        <a href="#question" data-toggle="tab"
                          ><span class="icon-tools-2"></span>질문</a
                        >
                      </li>
                    </ul>
                    <div class="tab-content">
                      ...
                      <div class="tab-pane active" id="description">
                        <p>
                          ...
                          the resulting language is more simple and regular than
                        ...
                        <div class="post #">
                          <div class="post-header font-alt">
                            ...
                            <div class="post-meta">
                              ㅇㄴㅁㅇㄴㅁㅇㄴ뭉나무이ㅏㄴ무ㅏㅣㅜ이ㅟㅏㄴ뮈안뮈ㅏ우ㅏㅣㄴ뮈ㅏ
                              하하하ㅏ하하하
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="post">
                          ...
                          >
                            <iframe
                              ...
                              src="//www.youtube.com/embed/Jkk0VHiCnKY"
                              frameborder="0"
                          ...
                          <div class="post-entry">
                            <p>
                              ...
                              feel the charm of existence in this spot, which
                        ...
                        <div class="comments reviews">
                            ...
                            <div class="comment-content clearfix">
                              ...
                              <div class="comment-body">
                                <p>
                                  ...
                                  the same vocabulary. The European languages
                                  are members of the same family. Their separate
                                  existence is a myth.
                                </p>
                              </div>
                          ...
                          <div class="comment clearfix">
                            ...
                            <div class="comment-content clearfix">
                              ...
                              <div class="comment-body">
                                <p>
                                  Europe uses the same vocabulary. The European
                      ...
                      <div class="col-sm-12">
                        ...
                        <div class="btn-group">
                          ...
                          >
                            ...
                            <li style="border: 1 solid black" id="timeSelector">
                              <!-- 시간 시작 -->
                              <h6>시간을 눌러주세요</h6>
    ...
    <script>
      const calendarDays = document.querySelectorAll(".calendar_days"),
        ...
        dayText = document.querySelector("#dayText"), // 일수
        dateText = document.querySelector("#dateText"), // 날짜
        finalDate = document.querySelector("#finalDate"), // 두개 합치기 날짜
        finalTime = document.querySelector("#finalTime"), // 두개 합치기 시간
        swiperSlide = document.querySelector(".swiper-wrapper"),
        timeSelector = document.querySelector("#timeSelector"), // 시간
        timeDays = document.querySelector("#time_days"); // 시간
      ...
      class Time {
        fillTime() {
          ...
          for (let i = 1; i < 24; i++) {
            swiperSlide.innerHTML += `<div class="swiper-slide time_days"><button class="btn time_button">${i}</button></div>`;
          }
        }
        ...
        updateTimeStyle() {
          ...
          timeButtons.forEach((element) => {
            element.classList.remove("time_selected");
            timeButtons.forEach((e) => e.classList.remove("gray"));
          });

          // 시간들에 클릭 이벤트 추가
          timeButtons.forEach((element) => {
            element.addEventListener("click", (event) => {
              event.target.classList.toggle("time_selected");
              ...
              if (clickCount > 2 || number < firstSelectedTime) {
                ...
                firstSelectedTime = 0;
                lastSelectedTime = 0;
                console.log("초기화" + firstSelectedTime, lastSelectedTime);
                finalTime.innerText = null;
              }

              if (firstSelectedTime === 0) {
                firstSelectedTime = number;
              } else {
                lastSelectedTime = number;
              }

              // 선택 일자 사이에 회색 배경 적용
              if (firstSelectedTime !== 0 && lastSelectedTime !== 0) {
                timeButtons.forEach((e) => {
                  const time = Number(e.innerText);
                  if (time >= firstSelectedTime && time <= lastSelectedTime) {
                    e.parentNode.classList.add("gray");
                    finalTime.innerText = `${firstSelectedTime}시 ~ ${lastSelectedTime}시`;
                  } else {
                    e.parentNode.classList.remove("gray");
                  }
                });
              ...
              if (firstSelectedTime > lastSelectedTime) {
                timeButtons.forEach((e) => {
                  e.parentNode.classList.remove("gray");
                });
              }
          ...
          timeButtons.forEach((element) => {
            element.addEventListener("mouseenter", (event) => {
              event.target.classList.add("time_hover");
            });
          });

          timeButtons.forEach((element) => {
            element.addEventListener("mouseleave", (event) => {
              event.target.classList.remove("time_hover");
            });
          });
        }
      ...
      class Calendar {
        ...
        fillCalendar() {
          ...
          dateText.innerHTML = `${this.year}년 ${this.month + 1}월`;
        ...
        updateCalendarStyle() {
          ...
          dayButtons.forEach((element) => {
            element.addEventListener("click", (event) => {
              ...
              // 선택 일자 타입 변환
              if (selectedDay === 0) {
                selectedDay = Number(event.target.innerText);
              }
              ...
              if (selectedDay !== 0) {
                dayButtons.forEach((e) => {
                  ...
                  if (day == selectedDay) {
                    ...
                    // 일수 확인 기능
                    finalDate.innerHTML = `${String(day)}일 ${
